...
from utils.general import bbox_iou,  box_iou,  xywh2xyxy, nms
import torchvision
...
class ComputeLoss:
    ...
    def build_targets(self, p, targets):
        ...
        for i in range(self.nl):#layer
            anchors = self.anchors[i]
        
            gain[2:6] = torch.tensor(p[i].shape)[[3, 2, 3, 2]]  # xyxy gain #[1,1,x,y,x,y,1]
            ...
            if nt:
                ...
                r = t[:, :, 4:6] / anchors[:, None]  # wh ratio  [an,nt,2(w,h)]
...
class ComputeLossOTA:
    ...
    def __init__(self, model, autobalance=False):
        ...
        device = "cuda:0"#next(model.parameters()).device  # get model device
        h = model.hyp  # hyperparameters
    ...
    def build_targets(self, p, targets, imgs):
        ...
        for batch_idx in range(p[0].shape[0]):
            ...
            matching_matrix = torch.zeros_like(cost,device="cuda:0")
